    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="flex flex-col lg:flex-row justify-center items-start py-12 px-4 gap-12 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-700 mb-4">
            We specialize in connecting employers with skilled professionals.
            Provide accurate details of your hiring requirements to ensure we
            find the best fit for your organization.
          </p>

          <p className="text-gray-700 mb-4">
            Our recruitment process is tailored to your needs, from shortlisting
            qualified candidates to scheduling interviews. We save you time and
            resources while ensuring quality hires.
          </p>
          ...
          <p className="text-gray-700">
            Fill out the form with accurate details, including company
            information, contact person, and the position you want to hire for.
            Our team will contact you with the best candidates for your needs.
          </p>
        </motion.div>
